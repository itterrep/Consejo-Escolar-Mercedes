Public Class FrmInformeFacturasXCue
    ...
    Private Sub FrmInformeFacturasXfecha_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
   ...
   <meta name='viewport' content='width=device-width, initial-scale=1, shrink-to-fit=no'>
    ...
    <link rel='stylesheet' href='https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css'>
     ...
     <body>
        ...
        <br>
        <h3 class='text-center'> De la escuela " & NombreCue & " CUE Nº " & TCue & " </h3>
        <br>
        <div class='container'>
