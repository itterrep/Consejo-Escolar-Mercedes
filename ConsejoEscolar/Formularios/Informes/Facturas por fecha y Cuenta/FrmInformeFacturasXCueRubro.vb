Public Class FrmInformeFacturasXCueRubro
    ...
    Dim TRubro As String = GlobalRubro
   ...
   <meta name='viewport' content='width=device-width, initial-scale=1, shrink-to-fit=no'>
    ...
    <link rel='stylesheet' href='https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css'>
     ...
     <body>
        ...
        <br>
        <h3 class='text-center'> De la escuela " & NombreCue & " CUE Nº " & TCue & " y Rubro " & TRubro & " </h3>
        <br>
        <div class='container'>
